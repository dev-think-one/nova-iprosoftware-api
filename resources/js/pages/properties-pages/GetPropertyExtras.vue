<template>
    <div>
        <Heading class="mb-6">{{ __('Get Property Extras') }}</Heading>
        <div class="flex mb-4">
            <input
                type="number"
                step="1"
...
export default {
    ...
    methods: {
        onRequestSuccess(response) {
            ...
            Nova.success(this.__('Success response. Fetched property extras count: :count.', {count: this.responseData.length}))
        },
        ...
        getRequestUrl() {
            return this.requestUrl + this.iproId + '/extras';
        }
    }
}
</script>
